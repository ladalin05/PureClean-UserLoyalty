...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"PureClean Laundromat Management System"},{"name":"robots","content":"index, follow, noarchive"},{"name":"author","content":"Mengly Uch"},{"name":"theme-color","content":"#ffffff"}],"link":[{"rel":"icon","type":"image/png","href":"/logo/favicon/favicon-32x32.png","sizes":"32x32"},{"rel":"icon","type":"image/png","href":"/logo/favicon/favicon-16x16.png","sizes":"16x16"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/logo/favicon/apple-touch-icon.png"}],"style":[],"script":[],"noscript":[],"title":"PureClean x Butum Sakor"};
